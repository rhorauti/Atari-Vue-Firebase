        ...
        <div class="columns">
            ...
            <div class="column">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="modalClientes.id" type="text" class="input is-small is-info has-background-white" disabled>
                    </div>
                </div>
                <!--Nome-->
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="modalClientes.nome" type="text" :class="{'is-danger': !isNomeValido}" class="input is-info is-small">
                    </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="modalClientes.cnpj" @input="atualizarCnpjVmaska($event.target.value)" type="text" class="input is-info is-small" v-maska :data-maska="vMaskaCnpj">
                    </div>
                </div>
                <!--Email-->
                <div class="field">
                    ...
                    <div class="control">
                        <input v-model="modalClientes.email" type="email" class="input is-info is-small" placeholder="exemple@gmail.com" >
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                ...
                <div class="field"> 
                    ...
                    <div class="control">
                        <input v-model="modalClientes.telefone" @input="atualizarTelefoneVmaska($event.target.value)" type="tel" class="input is-info is-small" placeholder="(xx) xxxxx-xxxx" v-maska :data-maska="vMaskaTelefone">
                    </div>
                </div>
                <!--Endereço-->
                <div class="field"> 
                    ...
                    <div class="control">
                        <input v-model="modalClientes.endereco" type="text" class="input is-info is-small">
                    </div>
                </div>
                <!--Bairro-->
                <div class="field"> 
                    ...
                    <div class="control">
                        <input v-model="modalClientes.bairro" type="text" class="input is-info is-small">
                    </div>
                </div>
                <!--Cidade-->
                <div class="field"> 
                    ...
                    <div class="control">
                        <input v-model="modalClientes.cidade" type="text" class="input is-info is-small">
                    </div>
                </div>
                <!--UF-->
                <div class="field"> 
